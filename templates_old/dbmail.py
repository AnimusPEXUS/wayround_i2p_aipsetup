...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --with-mysql --with-pgsql --with-sqlite  --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
