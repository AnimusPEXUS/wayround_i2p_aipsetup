...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --disable-libuuid --disable-libblkid  --prefix=/usr --bindir=/bin --sbindir=/sbin --sysconfdir=/etc --localstatedir=/var --enable-elf-shlibs --disable-fsck --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
