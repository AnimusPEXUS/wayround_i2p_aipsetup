...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --enable-alsa-midi --enable-alsatest --enable-sdltest --enable-opengl --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
