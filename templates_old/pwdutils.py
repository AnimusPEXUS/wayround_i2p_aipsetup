...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --disable-selinux --host=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
