...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --enable-shared --enable-gpl --enable-libtheora --enable-libvorbis --enable-x11grab --enable-libmp3lame --enable-libx264 --enable-libxvid --enable-runtime-cpudetect """,
            'RELATIVELY'   : True,
