...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --with-ffmpeg --with-libvorbis --with-libflac  --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
