...
class Builder(wayround_i2p.aipsetup.builder_scripts.std.Builder):
    ...
    def define_custom_data(self):
        ...
        e = wayround_i2p.utils.osutils.env_vars_edit(e, 'copy')
        ...
        ret = {
            ...
            'user_config': wayround_i2p.utils.path.join(
                self.get_src_dir(),
                'user-config.jam'
                ),
...
""".format(
                    compiler=wayround_i2p.utils.file.which(
    ...
    def builder_action_build(self, called_as, log):
        ...
        args = [
            wayround_i2p.utils.path.join(self.get_src_dir(), 'b2'),
