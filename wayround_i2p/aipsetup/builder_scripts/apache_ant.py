...
class Builder(wayround_i2p.aipsetup.builder_scripts.std.Builder):
    ...
    def define_custom_data(self):
        src_ant_dir = wayround_i2p.utils.path.join(
            self.get_src_dir(),
            'dist'
            #'apache-ant-{}'.format(
        ...
        ant_dir = wayround_i2p.utils.path.join(
        ...
        dst_ant_dir = wayround_i2p.utils.path.join(
            self.get_dst_dir(),
            ant_dir
            )
        ...
        apacheant009 = wayround_i2p.utils.path.join(
            etc_dir,
