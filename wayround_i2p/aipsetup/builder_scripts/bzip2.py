...
class Builder(wayround_i2p.aipsetup.builder_scripts.std.Builder):
    ...
    def builder_action_copy_so(self, called_as, log):
        ...
        di = wayround_i2p.utils.path.join(
        ...
        try:
            ...
            for i in sos:
                ...
                j = wayround_i2p.utils.path.join(self.get_src_dir(), base)
                j2 = wayround_i2p.utils.path.join(di, base)
    ...
    def builder_action_fix_links(self, called_as, log):
        ...
        try:
            for i in files:
                ...
                ff = wayround_i2p.utils.path.join(bin_dir, i)
    ...
    def builder_action_fix_libdir_positions(self, called_as, log):
        ...
        for i in [
            ...
            jf = wayround_i2p.utils.path.join(
                i, fldn
                )
