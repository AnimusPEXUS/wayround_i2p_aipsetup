...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --with-answer-all=no --with-editor=`which emacs` --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
