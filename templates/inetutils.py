...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --bindir=/bin  --sbindir=/usr/sbin --sysconfdir=/etc --localstatedir=/var --enable-shared --enable-servers --enable-clients --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
