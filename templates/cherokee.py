...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --with-wwwroot=/var/www --with-wwwuser=httpd --with-wwwgroup=httpd --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
