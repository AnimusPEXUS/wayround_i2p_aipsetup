...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --with-system-pnglib --with-system-freetype2 --with-system-zlib --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
