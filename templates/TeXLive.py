...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure  --without-xindy --with-system-freetype --with-system-freetype2 --with-system-ncurses --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
