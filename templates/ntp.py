...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --enable-all-clocks --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
        ...
        {
            'RUN'          : """ mkdir -p "$bs_install_dir/usr/share/ntp" """,
            'RELATIVELY'   : False,
        ...
        {
            'RUN'          : """ cp -av html conf "$bs_install_dir/usr/share/ntp" """,
            'RELATIVELY'   : False,
            'ERRORMESSAGE' : '*** some make install error',
            'EXITONERROR'  : True
            },
