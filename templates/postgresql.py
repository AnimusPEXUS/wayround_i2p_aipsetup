...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --with-tcl --with-tclconfig=/usr/lib --with-perl --with-python --with-openssl --with-libxml --with-libxslt --build=i486-pc-linux-gnu --host=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
