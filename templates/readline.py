...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-static --enable-shared --with-curses --enable-multibyte --host=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
