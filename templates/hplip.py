...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --enable-foomatic-rip-hplip-install --enable-hpijs-install --enable-hpcups-install --enable-gui-build --enable-foomatic-ppd-install --enable-foomatic-drv-install --enable-cups-drv-install --enable-cups-ppd-install  --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
