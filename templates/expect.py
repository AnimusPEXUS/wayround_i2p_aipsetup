...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --enable-threads --enable-64bit --enable-64bit-vis --enable-wince  --with-tcl=/usr/lib --with-tk=/usr/lib --host=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
