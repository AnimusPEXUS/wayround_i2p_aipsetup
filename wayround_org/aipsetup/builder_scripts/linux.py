...
class Builder(wayround_org.aipsetup.builder_scripts.std.Builder):
    ...
    def builder_action_distr_kernel(self):
        ...
        return ret
    def builder_action_distr_modules(self):
        ret = autotools.make_high(
            buildingsite,
            options=[],
            arguments=[
        ...
        if ret == 0:
            ...
            del(files)
        return ret
    def builder_action_distr_firmware(self):
        ret = autotools.make_high(
            buildingsite,
            options=[],
            arguments=[
        ...
        return ret
    def builder_action_distr_headers_internal(self):
        ...
        return ret
    def builder_action_distr_headers_normal(self):
        ret = autotools.make_high(
            buildingsite,
            options=[],
            arguments=[
        ...
        return ret
    def builder_action_distr_headers_internal_repeat(self):
        ...
        return ret
    def builder_action_distr_arch_headers_internal(self):
...
""")
        ...
        ret = 1
        return ret
    def builder_action_remove_install_files_from_includes(self):
        p = subprocess.Popen(
            ['find',
             '(', '-name', '.install',
             '-o', '-name', '..install.cmd',
        ...
        p.wait()
        return ret
    def builder_action_distr_man(self):
        ret = autotools.make_high(
            buildingsite,
            options=[],
            arguments=[
        ...
        return ret
    def builder_action_copy_source(self):
        try:
