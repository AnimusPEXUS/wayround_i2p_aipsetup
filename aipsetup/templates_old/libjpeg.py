...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ mkdir -p "$bs_install_dir/usr/include" "$bs_install_dir/usr/bin" "$bs_install_dir/usr/lib" "$bs_install_dir/usr/man/man1" "$bs_install_dir/usr/man/man5" "$bs_install_dir/usr/man/man8" """,
            'RELATIVELY'   : False,
