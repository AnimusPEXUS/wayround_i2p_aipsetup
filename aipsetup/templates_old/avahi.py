...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --disable-qt3 --disable-qt4 --with-distro=none --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu """,
            'RELATIVELY'   : True,
