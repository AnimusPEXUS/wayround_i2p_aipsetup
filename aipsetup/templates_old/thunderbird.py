...
template={
    ...
    'stages'           : [
        ...
        {
            'RUN'          : """ configure --prefix=/usr --sysconfdir=/etc --localstatedir=/var --enable-shared --with-system-jpeg --with-system-zlib --with-system-bz2 --enable-application=mail --host=i486-pc-linux-gnu --build=i486-pc-linux-gnu  """,
            'RELATIVELY'   : True,
